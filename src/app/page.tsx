  ...
  return (
    <div className="bg-black text-white min-h-screen">
      ...
      <header className="fixed top-0 left-0 w-full bg-black bg-opacity-80 backdrop-blur-md z-50 p-5 flex justify-between items-center">
        <h1 className="text-2xl font-bold">Priscilla Boatemaa Antwi</h1>
        <nav>
      ...
      <section
        ...
        style={{ backgroundImage: "url(/IMG-20250308-WA0020.jpg)" }}
      >
        <motion.h1
      ...
      <section id="portfolio" className="py-20 px-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {["/IMG-20250308-WA0020.jpg", "/IMG-20250308-WA0021.jpg", "/IMG-20250308-WA0021.jpg", "/IMG-20250308-WA0021.jpg", "/IMG-20250308-WA0021.jpg", "/IMG-20250308-WA0024.jpg"].map((image, i) => (
            <motion.div
              key={i}
            ...
            >
              <img src={image} alt={`Project ${i + 1}`} className="h-64 w-full object-cover rounded-md" />
      ...
      <section id="contact" className="py-20 px-10 text-center">
        ...
        <div className="flex justify-center space-x-6 text-3xl">
          <a href="https://www.instagram.com/yourusername" target="_blank" rel="noopener noreferrer" className="hover:text-gray-400">
            <FaInstagram />
          </a>
          <a href="https://wa.me/yourwhatsappnumber" target="_blank" rel="noopener noreferrer" className="hover:text-gray-400">
            <FaWhatsapp />
          </a>
          <a href="mailto:youremail@example.com" className="hover:text-gray-400">
            <FaEnvelope />
          </a>
          <a href="https://www.tiktok.com/@yourusername" target="_blank" rel="noopener noreferrer" className="hover:text-gray-400">
            <FaTiktok />
          </a>
        </div>
      </section>
